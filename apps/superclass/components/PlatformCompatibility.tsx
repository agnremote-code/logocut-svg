...
export function PlatformCompatibility() {
  return <section className="platform-section" aria-labelledby="platform-title">
    <div><span className="section-kicker">FITS YOUR EXISTING TEACHING WORKFLOW</span><h2 id="platform-title">Teach through the platform you already use.</h2><p>Designed for tutors and teachers who use online tutoring marketplaces, video calls and private messaging to run personalized classes.</p></div>
