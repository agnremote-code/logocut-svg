...
const faqs=[
 ...
 ["Do I need an account or subscription?","No. There is no account and no subscription. Each clean SVG is a one-time purchase."],
...
export function HomePage(){useEffect(()=>trackEvent("homepage_view",{source_page:"homepage"}),[]);return <main className="premium-page">
 ...
 <header className="premium-hero"><p className="hero-pill">IMAGE TO SVG, WITHOUT THE GUESSWORK</p><h1>Convert Any Image Into a Clean, Cut-Ready SVG</h1><p>Upload a PNG or JPG, preview the result for free, and pay only when it looks right.</p><span>No account · No subscription · Single-color $5 · Layered $9</span></header>
